//definição das palavras secretas
alert('Novo Jogo')
const tecnologias = ["java", "react", "node", "python", "php"];
//método que define de forma pseudoaleatória as palavras secretas)
const palavraSecreta =
  tecnologias[Math.floor(Math.random() * tecnologias.length)];
//variáveis de armazenamento das letras erradas e certas.
const letrasErradas = [];
const letrasCorretas = [];

//processo q verifica quais teclas foram selecionadas e se as teclas selecionadas estão entre (a - z)
...
//escreve na tela as letras erradas através do método innerHTML.
